...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="card mt-4">
            <div class="card-body">
                <table class="table table-striped table-hover table-bordered" style="font-size: 0.875rem">
                    <thead>
                      <tr>
                        <th scope="col">#</th>
                    ...
                    @foreach ($transactions as $trx)
                      ...
                      <tr>
                        <td scope="row">{{ $trx->id ?? '' }}</td>
                        <td scope="row">{{ $trx->name ?? '' }}</td>
                        <td scope="row">{{ $trx->email ?? '' }}</td>
                        <td scope="row">{{ $trx->phone ?? '' }}</td>
                        <td scope="row">{{ $trx->amount ?? '' }}</td>
                        <td scope="row">{{ $trx->method ?? '' }}</td>
                        <td scope="row">{{ $trx->bk_reference ?? '' }}</td>
                        <td scope="row">{{ $trx->bk_status ?? '' }}</td>
                        <td scope="row">{{ $trx->receive_amount ?? '' }}</td>
                        <td scope="row">{{ $trx->note ?? '' }}</td>
                        <td scope="row">{{ $trx->created_at ?? '' }}</td>
                      </tr>
